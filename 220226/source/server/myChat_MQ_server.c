...
int main(int argc, char *argv[])
{
    ...
    /*
     * Потоки:
     * 1. Следит за очередью сообщений "users". В эту очередь будут "подключаться" новые пользователи
     * 2. Следит за очередью сообщений "name_room". В эту очередь будут приходить все сообщения от пользователей
